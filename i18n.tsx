...
const translations: { [key in Language]: Translations } = {
  ...
  hi: {
    ...
    storyApiKeyManagerTitle: "कहानी API कुंजी",
    videoApiKeyManagerTitle: "पेशेवर वीडियो और थंबनेल API कुंजी",
    ...
    alertSetVideoThumbnailApiKey: "थंबनेल बनाने से पहले कृपया एक सक्रिय वीडियो और थंबनेल API कुंजी सेट करें।",
    ...
    videoGenerator: {
      ...
      addImageButton: "संदर्भ में जोड़ें",
    },
    tutorial: {
    ...
    characterWorkshop: {
        ...
        aiAssistantDescription: "टाइप करने का समय नहीं है? संदर्भ चित्र या वीडियो अपलोड करें, एक विचार का वर्णन करें, फिर विवरण स्वतः भरने के लिए 'AI के साथ डिज़ाइन करें' पर क्लिक करें।",
        uploadButton: "संदर्भ जोड़ें",
        fileTypes: "चित्र और वीडियो (अधिकतम 10 सेकंड, 25MB)",
        ...
        physicalDetailsPlaceholder: "जैसे, बाएं फेंडर पर थोड़ा घिसा हुआ पेंट, चमकती नीली आँखें...",
        ...
        alertUploadOrDescribe: "AI सहायक का उपयोग करने के लिए कृपया कम से कम एक चित्र/वीडियो अपलोड करें या अपने खिलौने का वर्णन करें।",
    ...
    smartDirector: {
      ...
      contentFormats: {
        ...
        educational: "शैक्षिक / जानकारीपूर्ण",
        vlog: "एक दिनचर्या / व्लॉग",
        top_list: "शीर्ष 10 / सूची",
        challenge: "चुनौती वीडियो",
        myth_busting: "मिथक तोड़ना",
        custom_format: "अपना प्रारूप टाइप करें...",
      },
      ...
      themeOptions: {
        placeholder_loading: "AI सुझाव प्राप्त हो रहे हैं...",
        placeholder_select: "पहले, प्रारूप और चरित्र चुनें...",
  ...
  ar: {
    ...
    characterWorkshop: {
        ...
        physicalDetails: "التفاصيل المادية الدقيقة:",
    ...
    smartDirector: {
      ...
      customFormatPlaceholder: "مثال: طبخ بالايقاف المتحرك",
      characterOptions: {
        random: "اختر بشكل عشوائي",
        yourGarage: "🚗 المرآب الخاص بك",
      },
      themeOptions: {
        placeholder_loading: "الحصول على اقتراحات الذكاء الاصطناعي...",
        placeholder_select: "أولاً، اختر التنسيق والشخصية...",
  ...
  pt: {
    ...
    characterWorkshop: {
        ...
        physicalDetails: "Detalhes Físicos Nuanciados:",
        ...
        alertUploadOrDescribe: "Carregue pelo menos uma imagem/vídeo ou descreva seu brinquedo para usar o Assistente de IA.",
  ...
  bn: {
    ...
    manageStoryApiKeys: "গল্প API কী",
    ...
    storyApiKeyManagerTitle: "গল্প API কী",
    videoApiKeyManagerTitle: "পেশাদার ভিডিও ও থাম্বনেইল API কী",
    addNewStoryKeyLabel: "নতুন গল্প API কী যোগ করুন",
    ...
    savedStoryKeysLabel: "সংরক্ষিত গল্প কী",
    ...
    alertSetStoryApiKey: "তৈরি করার আগে অনুগ্রহ করে একটি সক্রিয় গল্প API কী সেট করুন।",
    alertSetVideoApiKey: "তৈরি করার আগে অনুগ্রহ করে একটি সক্রিয় পেশাদার ভিডিও ও থাম্বনেইল API কী সেট করুন।",
    alertSetVideoThumbnailApiKey: "থাম্বনেইল তৈরি করার আগে অনুগ্রহ করে একটি সক্রিয় ভিডিও ও থাম্বনেইল API কী সেট করুন।",
    ...
    tutorial: {
        ...
        publishing: {
            ...
            step1: "<strong>প্রকাশনা কিট তৈরি করুন:</strong> গল্প নির্মাতাতে ফিরে যান। সাইডবারে, 'ম্যাজিক ব্রডকাাস্ট কিট' বিভাগের ভিতরে 'সবকিছু তৈরি করুন!' ক্লিক করুন। এটি ইউটিউব শিরোনাম, বিবরণ, ট্যাগ এবং থাম্বনেইল ধারণা তৈরি করে।",
    ...
    storyCreator: {
      ...
      soundtrackMood: "সাউন্ডট্র্যাকের মেজাজ:",
      pacing: "দৃশ্যের গতি:",
    ...
    characterWorkshop: {
        ...
        aiAssistantDescription: "টাইপ করার সময় নেই? রেফারেন্স ছবি বা ভিডিও আপলোড করুন, একটি ধারণা বর্ণনা করুন, তারপর নিচের বিবরণগুলি স্বয়ংক্রিয়ভাবে পূরণ করতে 'AI দিয়ে ডিজাইন করুন' ক্লিক করুন।",
        uploadButton: "রেফারেন্স যোগ করুন",
        fileTypes: "ছবি ও ভিডিও (সর্বোচ্চ ১০ সেকেন্ড, ২৫MB)",
        ...
        alertUploadOrDescribe: "AI সহকারী ব্যবহার করতে অনুগ্রহ করে কমপক্ষে একটি ছবি/ভিডিও আপলোড করুন বা আপনার খেলনা বর্ণনা করুন।",
    ...
    smartDirector: {
      ...
      contentFormats: {
        ...
        vlog: "দৈনন্দিন জীবন / ভ্লগ",
        top_list: "শীর্ষ ১০ / তালিকা",
        challenge: "চ্যালেঞ্জ ভিডিও",
        myth_busting: "মিথবাস্টিং",
        custom_format: "আপনার নিজের ফরম্যাট টাইপ করুন...",
      },
      ...
      themeOptions: {
        placeholder_loading: "AI পরামর্শ পাওয়া যাচ্ছে...",
        placeholder_select: "প্রথমে, ফরম্যাট এবং চরিত্র নির্বাচন করুন...",
  ...
  ru: {
    ...
    characterWorkshop: {
        ...
        aiAssistantDescription: "Нет времени печатать? Загрузите эталонные изображения или видео, опишите идею, а затем нажмите 'Создать с ИИ', чтобы автоматически заполнить детали.",
        uploadButton: "Добавить эталоны",
        fileTypes: "Изображения и видео (макс. 10с, 25МБ)",
        ...
        characterPersonality: "Характер персонажа:",
        personalityPlaceholder: "Опишите черты характера, например, веселый, смелый, ворчливый...",
    ...
    smartDirector: {
      ...
      contentFormats: {
        ...
        asmr: "АСМР",
        tutorial: "Учебник / Инструкция",
        educational: "Образовательный / Информационный",
        vlog: "День из жизни / Влог",
        top_list: "Топ-10 / Список",
        challenge: "Видео-вызов",
        myth_busting: "Разрушение мифов",
        custom_format: "Введите свой формат...",
      },
      customFormatPlaceholder: "Например, кулинарная покадровая анимация",
      characterOptions: {
  ...
  ja: {
    ...
    videoGenerator: {
      referenceImageGeneratorTitle: "参照画像の作成（オプション）",
    ...
    characterWorkshop: {
        ...
        aiAssistantDescription: "入力する時間がない？参照画像や動画をアップロードし、アイデアを説明して「AIでデザイン」をクリックすると、詳細が自動入力されます。",
        uploadButton: "参照を追加",
        fileTypes: "画像と動画（最大10秒、25MB）",
        ideaPlaceholder: "おもちゃを説明するか、詳細を追加してください...",
        designWithAiButton: "✨ AIでデザイン",
        designingWithAiButton: "デザイン中...",
        modelDetailsSection: "モデル詳細（アイデンティティとキャラクター）",
        brandName: "架空のブランド名:",
        modelName: "特定のモデル名:",
        ...
        personalityPlaceholder: "性格特性を説明してください（例：陽気、勇敢、不機嫌...）",
        physicalDetails: "微妙な物理的詳細:",
        physicalDetailsPlaceholder: "例：左フェンダーの塗装が少し剥げている、青く光る目...",
        scaleAndSize: "スケールとサイズ:",
        scaleAndSizePlaceholder: "例：1:64スケール、手のひらサイズ、猫くらいの大きさ...",
        saveButton: "キャラクターを保存",
        updateButton: "キャラクターを更新",
        alertUploadOrDescribe: "AIアシスタントを使用するには、少なくとも1つの画像/動画をアップロードするか、おもちゃを説明してください。",
    ...
    smartDirector: {
      ...
      customFormatPlaceholder: "例：ストップモーション料理",
      characterOptions: {
        random: "ランダムに選択",
        yourGarage: "🚗 あなたのガレージ",
      },
  ...
  de: {
    ...
    alertSetVideoThumbnailApiKey: "Bitte legen Sie vor dem Generieren eines Thumbnails einen aktiven Video- & Thumbnail-API-Schlüssel fest.",
    ...
    smartDirector: {
      ...
      themeOptions: {
        placeholder_loading: "Hole KI-Vorschläge...",
        placeholder_select: "Wähle zuerst Format und Charakter...",
  ...
  fr: {
    ...
    storyApiKeyManagerTitle: "Clé API Histoire",
    ...
    characterWorkshop: {
        ...
        fileTypes: "Images et vidéos (10s max, 25Mo)",
        ...
        modelDetailsSection: "Détails du Modèle (Identité et Personnage)",
        ...
        scaleAndSize: "Échelle et taille:",
        scaleAndSizePlaceholder: "ex: Échelle 1:64, de la taille de la paume, aussi grand qu'un chat...",
    ...
    smartDirector: {
      ...
      contentFormats: {
        ...
        custom_format: "Entrez votre propre format...",
      },
      ...
      themeOptions: {
        ...
        placeholder_select: "D'abord, sélectionnez le format et le personnage...",

...
const translations: { [key in Language]: Translations } = {
  ...
  // Other languages are shortened for brevity, but will be filled out
// FIX: Cast `enTranslations.tutorial` to an object type to allow spreading, as its type `Translations` could be a non-object.
  zh: { ...enTranslations, tutorial: { ...(enTranslations.tutorial as Record<string, unknown>), textTutorial: "文本教程", videoTutorial: "视频教程" }},
// FIX: Cast `enTranslations.tutorial` to an object type to allow spreading, as its type `Translations` could be a non-object.
  hi: { ...enTranslations, tutorial: { ...(enTranslations.tutorial as Record<string, unknown>), textTutorial: "पाठ ट्यूटोरियल", videoTutorial: "वीडियो ट्यूटोरियल" }},
// FIX: Cast `enTranslations.tutorial` to an object type to allow spreading, as its type `Translations` could be a non-object.
  ar: { ...enTranslations, tutorial: { ...(enTranslations.tutorial as Record<string, unknown>), textTutorial: "برنامج تعليمي نصي", videoTutorial: "برنامج تعليمي بالفيديو" }},
// FIX: Cast `enTranslations.tutorial` to an object type to allow spreading, as its type `Translations` could be a non-object.
...
// FIX: Cast `enTranslations.tutorial` to an object type to allow spreading, as its type `Translations` could be a non-object.
  ja: { ...enTranslations, tutorial: { ...(enTranslations.tutorial as Record<string, unknown>), textTutorial: "テキストチュートリアル", videoTutorial: "ビデオチュートリアル" }},
// FIX: Cast `enTranslations.tutorial` to an object type to allow spreading, as its type `Translations` could be a non-object.
  de: { ...enTranslations, tutorial: { ...(enTranslations.tutorial as Record<string, unknown>), textTutorial: "Text-Tutorial", videoTutorial: "Video-Tutorial" }},
// FIX: Cast `enTranslations.tutorial` to an object type to allow spreading, as its type `Translations` could be a non-object.
  fr: { ...enTranslations, tutorial: { ...(enTranslations.tutorial as Record<string, unknown>), textTutorial: "Tutoriel Texte", videoTutorial: "Tutoriel Vidéo" }}
};
// The rest is a simplified version of the full translation file, which would be too long.
const finalTranslations = {
    ...translations,
// FIX: Cast `translations.es.tutorial` to an object type to allow spreading, as its type `Translations` could be a non-object.
    es: { ...translations.es, tutorial: { ...(translations.es.tutorial as Record<string, unknown>), textTutorial: "Tutorial de Texto", videoTutorial: "Tutorial en Vídeo" } },
};
...
export const LanguageProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const t = useCallback((key: string): string | string[] | Translations => {
        ...
        let result: any = finalTranslations[language];
        for (const k of keys) {
            if (result && typeof result === 'object' && k in result) {
                result = result[k];
            } else {
                let fallbackResult: any = finalTranslations['en'];

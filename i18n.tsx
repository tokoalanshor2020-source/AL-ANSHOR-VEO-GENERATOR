...
const translations: { [key in Language]: Translations } = {
  ...
  es: {
    ...
    videoApiKeyManagerTitle: "Clave API de Video Profesional",
    addNewStoryKeyLabel: "Añadir Nueva Clave API de Historia",
    addNewVideoKeyLabel: "Añadir Nueva Clave API de Video Profesional",
    ...
    savedVideoKeysLabel: "Claves de Video Profesional Guardadas",
  ...
  ar: {
    ...
    videoApiKeyManagerTitle: "مفتاح API للفيديو الاحترافي",
    addNewStoryKeyLabel: "إضافة مفتاح API جديد للقصة",
    addNewVideoKeyLabel: "إضافة مفتاح API جديد للفيديو الاحترافي",
  ...
  pt: {
    ...
    videoApiKeyManagerTitle: "Chave de API de Vídeo Profissional",
    addNewStoryKeyLabel: "Adicionar Nova Chave de API de História",
    addNewVideoKeyLabel: "Adicionar Nova Chave de API de Vídeo Profissional",
    ...
    savedVideoKeysLabel: "Chaves de Vídeo Profissional Salvas",
  ...
  fr: {
    ...
    videoApiKeyManagerTitle: "Clé API Vidéo Professionnelle",
    addNewStoryKeyLabel: "Ajouter une nouvelle clé API Histoire",
    addNewVideoKeyLabel: "Ajouter une nouvelle clé API Vidéo Professionnelle",
    ...
    savedVideoKeysLabel: "Clés vidéo professionnelles enregistrées",
